...
namespace StoreGoodsClass
{
    public class MobilePhones : StoreGoods
    {
        ...
        public MobilePhones(int id, string category, string title, double price) : base(id, category, title, price)
        {
            Id = id;
            Category = category;
            Title = title;
        ...
        public static MobilePhones BringingOneTypeToAnother(StoreGoods tov1, MobilePhones tov2)
        {
            MobilePhones tov3 = new MobilePhones(tov2.Id, tov2.Category, tov2.Title, tov2.Price);            
