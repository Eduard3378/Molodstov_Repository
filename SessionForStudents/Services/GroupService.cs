        ...
        public static void CreateGroup(GroupDTO groupDTO)
        {
            ...
            {                        
                db.Groups.Add(new Group
                {
                    ...
                    DateOfOffset = groupDTO.DateOfOffset,
                    DateOfOffset1 = groupDTO.DateOfOffset1,
                    DateOfOffset2 = groupDTO.DateOfOffset2,
                    DateOfExamination = groupDTO.DateOfExamination,
                    DateOfExamination1 = groupDTO.DateOfExamination1,
                    DateOfExamination2 = groupDTO.DateOfExamination2,
                });               
            }
        }
        /// <summary>
        ...
        public static void UpdateGroup(GroupDTO groupDTO)
        {
            using (SessionContext db = new SessionContext())
            {
                ...
                else
                {
                    ...
                    group.DateOfOffset = groupDTO.DateOfOffset;
                    group.DateOfOffset1 = groupDTO.DateOfOffset1;
                    group.DateOfOffset2 = groupDTO.DateOfOffset2;
                    group.DateOfExamination = groupDTO.DateOfExamination;
                    group.DateOfExamination1 = groupDTO.DateOfExamination1;
                    group.DateOfExamination2 = groupDTO.DateOfExamination2;
