...
{
    /// <summary>
    /// Class PaperEquilateralTriangleBuilder
    /// </summary>
    public class PaperEquilateralTriangleBuilder : FigureBuilder
    {
        /// <summary>
        /// Property Name
        /// </summary>
        ...
        /// <summary>
        /// Constructor PaperEquilateralTriangleBuilder(string n, Color color) : base(n, color)
        /// </summary>
        /// <param name="n"></param>
        /// <param name="color"></param>
        public PaperEquilateralTriangleBuilder(string n, Color color) : base(n, color)
        {            
            Name = n;
            Color = Convert.ToString(color);
        }
        /// <summary>
        /// Constructor PaperEquilateralTriangleBuilder(double[] thesize1, params double[] thesize2) : base(thesize1, thesize2)
        /// </summary>
        /// <param name="thesize1"></param>
        /// <param name="thesize2"></param>
        public PaperEquilateralTriangleBuilder(double[] thesize1, params double[] thesize2) : base(thesize1, thesize2)
        {
        ...
        /// </summary>
        /// <param name="v"></param>
        /// <returns>Creates an instance of the EquilateralTriangleFigure class with radius and color parameters (paper shape)</returns>
