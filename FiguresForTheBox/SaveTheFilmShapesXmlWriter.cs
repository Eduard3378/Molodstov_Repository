...
{
    /// <summary>
    /// Class SaveTheFilmShapesXmlWriter
    /// </summary>
    public class SaveTheFilmShapesXmlWriter
    {
        /// <summary>
        /// Method SaveTheFilmShapesXmlWriter1(Figures[] box1)
        /// </summary>
        /// <param name="box1"></param>
        public static void SaveTheFilmShapesXmlWriter1(Figures[] box1)
        {
