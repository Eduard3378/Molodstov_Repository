...
{
    /// <summary>
    /// Class SaveAllShapesXmlWriter
    /// </summary>
    public class SaveAllShapesXmlWriter
    {
        /// <summary>
        /// Method SaveAllShapesXmlWriter1(Figures[] box1)
        /// </summary>
        /// <param name="box1"></param>
        public static void SaveAllShapesXmlWriter1(Figures[] box1)
        {
