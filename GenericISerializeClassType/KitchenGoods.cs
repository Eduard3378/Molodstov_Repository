...
namespace GenericISerializeClassType
{
    ...
    [Serializable]
    [XmlType]
    public class KitchenGoods : IComparable<KitchenGoods>, ISerialize
    {
        ...
        public KitchenGoods(int id, string category, string title, decimal price) 
        {
            Id = id;
            Category = category;
            Title = title;
        ...
        /// <summary>
        /// Method CompareTo([AllowNull] KitchenGoods other)
        /// </summary>
        /// <param name="other"></param>
        /// <returns>Implementation of the IComparable interface</returns>
        public int CompareTo([AllowNull] KitchenGoods other)
        {
